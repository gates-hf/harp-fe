...
export async function render(mount, ctx) {
  ...
  ctx.actions.innerHTML = `
    <a class="btn btn--secondary btn--sm" href="#/pactum/payers">
      <span class="icon icon--sm">arrow_back</span>Back to payer list
    </a>`;
  ...
  // One handler per mount — see the note in payer-list.js.
  mount.onclick = (e) => {
