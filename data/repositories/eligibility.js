...
export const CHECK_TYPES = ['Manual', 'Auto-Registration', 'Re-check'];
...
/** What the check was run against — a policy label, or the self-pay fallback. */
export function coverLabel(row) {
  if (!row?.policyId) return 'Self-Pay';
